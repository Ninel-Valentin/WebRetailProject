        ...
        <>
            <nav>
                <Link to="wishlist" className="button">
                    <svg viewBox="0 0 212.045 212.045" className="opposite lightSvg">
                        <g>
                            <path
                ...
                <Link to="cart" className="button">
                    <svg viewBox="0 0 512 512" className="opposite lightSvg">
                        <g>
                ...
                <Link to="" className="button" id="home">
                    <svg viewBox="0 0 512 512" className="opposite lightSvg mobile">
                        <g>
                            <path
                ...
                <Link to="account" className="button">
                    <svg viewBox="0 0 45.532 45.532" className="opposite lightSvg">
                        <g>
                            <path
                ...
                <Link to="explore" className="button">
                    <svg className="opposite lightSvg" viewBox="0 0 124 124">
                        <g>
                            <path
